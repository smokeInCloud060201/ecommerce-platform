package com.karson.ecommerce.common.aop;
...
public class LoggableAspect {
    ...
    @Pointcut("within(com.karson.ecommerce.*) " +
            "&& @annotation(com.karson.ecommerce.common.anotations.LoggerBase) " +
    ...
    public Object controllerAroundAdvice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            log.info("Exit:{}() Elapsed time: {}ms with result = {}",
                    joinPoint.getSignature().getName(), getExecutionTime(start), result);
            return result;
        } catch (Exception e) {
